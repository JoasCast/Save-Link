    ...
    <v-card class="w-100 h-lg-screen bg-background d-flex align-center justify-space-evenly" image="@/assets/bg/bg-light.svg">
      ...
      <form class="w-33 d-flex flex-column align-center">
        ...
        <v-container>
          ...
          <p class="text-error " v-if="errMsg">{{errMsg}}</p>
        </v-container>

        <v-btn class="w-75 my-8 py-8 bg-primary d-flex align-center rounded-xl font-weight-light" type="button" @click="register" >Cadastrar</v-btn>
